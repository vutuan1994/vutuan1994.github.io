	...
	<div class="container">
		...
		<!--price-->
			...
			<div class="mid-popular">
                             ...
                             <c:forEach items="${dsproducttubrand }" var="producttubrand">
				<div class="col-sm-4 item-grid item-gr  simpleCart_shelfItem">
                                    
							<div class="grid-pro">
								<div  class=" grid-product " >
									<figure>		
										<a href='<c:url value ="single/${producttubrand.getProduct_id() }" />'>
											<div class="grid-img">
												<img  src='<c:url value = "/resources/${producttubrand.getProduct_image_back() }" />' class="img-responsive" alt="">
											</div>
											<div class="grid-img">
												<img  src='<c:url value = "/resources/${producttubrand.getProduct_image_forward() }" />' class="img-responsive"  alt="">
											</div>			
										</a>		
									</figure>	
								</div>
								<div class="women">
									...
									<h6><a href='<c:url value ="single/${producttubrand.getProduct_id() }" />'>${producttubrand.getProduct_name()}</a></h6>
                                                                        <p ><em class="item_price">${producttubrand.getProduct_price() } VNĐ</em></p>
								
                                                                        <a href="checkout/${producttubrand.getProduct_id() }" data-text="Thêm vào giỏ" class="but-hover1 item_add">Thêm vào giỏ</a>
								</div>
							</div>
						</div>
						</c:forEach>
